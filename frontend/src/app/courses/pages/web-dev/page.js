...
function WebDevPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h1 className="text-3xl font-bold mb-6 text-[#334155]">Web Development Playlists</h1>
      <p className="mb-6 italic">Explore the following Web Development playlists:</p>
