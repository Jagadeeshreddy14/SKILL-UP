...
function WebDevPage() {
  ...
  const webDevPlaylists = playlists.filter((playlist) => playlist.category === 'cyber-security');

  if (webDevPlaylists.length === 0) {
    return <p>No Cyber Security playlists found.</p>;
  }
  ...
  return (
    <div className="container mx-auto px-10 py-6 mt-16">
      ...
      <h1 className="text-3xl font-bold mb-6 text-[#334155]">Cyber Security Playlists</h1>
      <p className="mb-6 italic">Explore the following Cyber Security playlists:</p>
