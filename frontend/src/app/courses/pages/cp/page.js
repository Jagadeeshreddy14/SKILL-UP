...
function WebDevPage() {
  ...
  const webDevPlaylists = playlists.filter((playlist) => playlist.category === 'cp');

  if (webDevPlaylists.length === 0) {
    return <p>No Competitive Programming playlists found.</p>;
  }
  ...
  return (
    <div className="container mx-auto px-10 py-6 mt-16">
      ...
      <h1 className="text-3xl font-bold mb-6 text-[#334155]">Competitive Programming Playlists</h1>
      <p className="mb-6 italic">Explore the following Competitive Programming playlists:</p>
